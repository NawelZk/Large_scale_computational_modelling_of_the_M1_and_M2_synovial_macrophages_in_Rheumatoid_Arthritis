"""
This script calculate the mean vector of all the stable states that have the highest similarity score
...
fixpoints_max_similarity = pd.read_csv("a-computational-framework-to-build-and-calibrate-large-scale-boolean-models-main\\Attractors_filtering_based_on_similarity_scores\\M1_similarity_score_on_nodes.csv", index_col=None, header=0,sep=";")
...
json_names_filtered=pd.read_csv("a-computational-framework-to-build-and-calibrate-large-scale-boolean-models-main\\Extract_nodes_upstream_phenotype_of_interest\\M1_macrophage_nodes_upstream_phenotypes_in_json.csv", index_col=None, header=0)
...
occurences.to_csv('a-computational-framework-to-build-and-calibrate-large-scale-boolean-models-main\\Attractors_filtering_based_on_similarity_scores\\M1_occurence_per_node_in_fixpoints_with_max_similarity_on_nodes.csv')
