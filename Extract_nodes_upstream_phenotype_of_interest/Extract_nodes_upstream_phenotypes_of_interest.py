...
model_sbml = biolqm.load("a-computational-framework-to-build-and-calibrate-large-scale-boolean-models-main\\Extract_nodes_upstream_phenotype_of_interest\\M1_model_export_upstream_phenotype_of_interest.sbml")
...
json_names = pd.read_csv("a-computational-framework-to-build-and-calibrate-large-scale-boolean-models-main\\Extract_nodes_upstream_phenotype_of_interest\\M1_macrophage_all_nodes_in_json.csv", index_col=None, header=0)
...
json_names_filtered.to_csv("a-computational-framework-to-build-and-calibrate-large-scale-boolean-models-main\\Extract_nodes_upstream_phenotype_of_interest\\M1_macrophage_nodes_upstream_phenotypes_in_json.csv")
