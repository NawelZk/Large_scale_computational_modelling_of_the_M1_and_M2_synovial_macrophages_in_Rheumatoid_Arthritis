...
my_path = os.path.join("a-computational-framework-to-build-and-calibrate-large-scale-boolean-models-main","In_silico_simulations")
os.chdir(my_path)
...
df_stable.to_csv('stable_nodes.csv')
